...
export type AddReviewMutation = {
  addReview: { storeId: string; score: number; title: string; content: string };
};
...
export type AddStoreMutation = {
  addStore: { name: string; address: string; genre: string; score: number };
};
...
export type BooksQuery = {
  books: Array<{ title: string; price: number; createdAt: any }>;
};
...
export type GetBookQuery = {
  getBook: { title: string; price: number; createdAt: any };
};
...
export function useAddBookMutation(
  baseOptions?: Apollo.MutationHookOptions<AddBookMutation, AddBookMutationVariables>,
) {
...
export function useAddReviewMutation(
  baseOptions?: Apollo.MutationHookOptions<AddReviewMutation, AddReviewMutationVariables>,
) {
  const options = { ...defaultOptions, ...baseOptions };
...
export function useAddStoreMutation(
  baseOptions?: Apollo.MutationHookOptions<AddStoreMutation, AddStoreMutationVariables>,
) {
  const options = { ...defaultOptions, ...baseOptions };
 ...
 * });
 */
export function useRemoveStoreMutation(
  baseOptions?: Apollo.MutationHookOptions<RemoveStoreMutation, RemoveStoreMutationVariables>,
) {
  const options = { ...defaultOptions, ...baseOptions };
...
export function useGetReviewLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<GetReviewQuery, GetReviewQueryVariables>,
) {
  const options = { ...defaultOptions, ...baseOptions };
